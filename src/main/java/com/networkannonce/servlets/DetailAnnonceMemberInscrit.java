...
/**
 * Servlet implementation class DetailAnnonceMemberInscrit
 */
public class DetailAnnonceMemberInscrit extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      request.setAttribute("idmember",idmember.getIdmember());
