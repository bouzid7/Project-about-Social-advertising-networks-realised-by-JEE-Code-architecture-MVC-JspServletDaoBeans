...
/**
 * Servlet implementation class AnnonceUpdatedBySonmember
 */
public class AnnonceUpdatedBySonmember extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		    ...
		    String id2=request.getParameter("idM");  
	        int id=Integer.parseInt(id1);
	        int idm=Integer.parseInt(id2);
	        Member  deposerAnnonceMember= new Member();
			deposerAnnonceMember=MemDao.getMember(idm);
	        ...
	        a=AnnDao.getAnnonceOnly(id);
	        request.setAttribute("annonceUpdate",a);
	  		RequestDispatcher rd=request.getRequestDispatcher("UpdateAnnonceByMember.jsp");
